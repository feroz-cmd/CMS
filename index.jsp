<html>
<body style="background-image:url('https://gifdb.com/images/high/brahmi-hmm-nodding-yes-lb8cusvos05seksl.gif')" bgcolor="pink" text="blue">
<form action="verify.jsp">
<center><h1>COLLEGE MANAGEMENT SYSTEM AND SERVICES</center></h1>
